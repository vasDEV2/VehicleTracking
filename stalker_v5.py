...
while True:
    ...
    if tracker_locked:
            ...
            if success:
                ...
                lat,lon = geotag.geotag(distanceboi,math.radians(pan+vehicle.heading),vehicle.location.global_relative_frame.lat,vehicle.location.global_relative_frame.lon)
                ...
                yvel = spd*math.cos(math.radians(pan+vehicle.heading))
                xvel = spd*math.sin(math.radians(pan+vehicle.heading))
                if distanceboi >= 5:
