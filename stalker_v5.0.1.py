...
ground_station_ip = '192.168.1.69'
...
while True:
    ...
    if tracker_locked:
            ...
            if success:
                ...
                lat1,lon1,distanceboi,teta = geotag.geo_tag_karo(314.70596524,251.9527701,0.9,pitch,0,vehicle.location.global_relative_frame.lat,vehicle.location.global_relative_frame.lon,vehicle.heading)
                disx = distanceboi
