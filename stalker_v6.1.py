...
while True:
    ...
    if tracker_locked:
            ...
            if success:
                ...
                duri = distancesahihoplz - distancesahihoplzbuddha

                print("NEW DISTANCE:",distancesahihoplz)
                print("DURI:", duri)

                if curr_time - timerboi >=1:
                    distancesahihoplzbuddha = distancesahihoplz
                    spdo = duri/1
                    plat = lat
                    plon = lon
                    timerboi = time.time()
