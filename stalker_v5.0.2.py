...
while True:
    ...
    if tracker_locked:
            ...
            if success:
                ...
                distnacekyahai = 0.9*math.tan(math.radians(udpitch))
                lat1,lon1,distanceboi,teta = geotag.geo_tag_karo(target_x,target_y,0.9,pitch,0,vehicle.location.global_relative_frame.lat,vehicle.location.global_relative_frame.lon,vehicle.heading)
