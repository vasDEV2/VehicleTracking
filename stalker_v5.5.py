...
while True:
    ...
    if tracker_locked:
            ...
            if success:
                ...
                lat1,lon1,distanceboi,teta = geotag.geo_tag_karo(target_x,target_y,13,pitch,p,vehicle.location.global_relative_frame.lat,vehicle.location.global_relative_frame.lon,vehicle.heading)
